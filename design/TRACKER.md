...
- **attack L3** `[wip]` Bolts no longer lose size on bounce, only reduce in damage delt. Occasionally the boss jumps and slams into the floor, briefly energising every panel destroying any ground minions that are on those panels.
- **weapon class** `[ready]` Offensive
