...
- **attack L2** `[wip]` 2 sets of bolts with a longer bounce life, fired as a primary volley and a secondary volley which is shot on a slightly shallower angle causing the two paths to overlap.
