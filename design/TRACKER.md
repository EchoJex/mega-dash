...
- **hazard L2** `[wip]` Per sweep, after final panel has finished discharging, the arena brightness flickers dark normal dark, then after the last of the electrified panels have finished being electrified . The conductors are inert between arcs and can be stood under safely.
