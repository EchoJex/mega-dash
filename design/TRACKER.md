...
- **weapon** `[wip]` Offensive; Large rock shaped hammer. Slow swing on tap Ground-pound that creates shockwaves and stuns nearby enemies. Per-level scaling: shockwave size + stun duration.
