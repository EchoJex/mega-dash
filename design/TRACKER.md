...
- **arena** `[wip]` A very large plasma lamp in the background with occasionally different lightning lines; several platforms phase in and out in random locations
