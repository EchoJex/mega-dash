...
- **boss-applied** `[wip]` Player movement and attack speed reduced by 15 percent. Return to normal after 5 seconds. Stun stacks Using a multiplicative reduction of remaining movement and attack speed
