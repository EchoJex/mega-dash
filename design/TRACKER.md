...
- **attack L1** `[wip]` Infrequently fires up to 2 sequential zigzag lightning bolts that have a long yellow tail. These lightning bolts bounce on wide arcs on surfaces on contact with surfaces or the player. Damage and size and stun duration decrease with total travel distance
