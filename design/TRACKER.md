...
- **attribute (weapon)** `[wip]` add a low transparency red hue that becomes more transparent as the effect diminishes; moderate damage/flinch/knockback on touch, scaling down until Hot subsides. Hot affect shall last for 3s after the source that applied it has concluded. Does not affect player in any way.
