...
- **hazard L2** `[wip]` Same sweep, plus overhead conductors that drop a vertical St Elmo's fire looking bolt at fixed positions on a regular beat. The conductors are inert between arcs and can be stood under safely.
