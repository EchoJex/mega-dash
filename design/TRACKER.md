...
- **hazard L2** `[wip]` Same sweep, plus overhead wire bundles that drop a vertical bolts at fixed positions on a regular beat. The conductors are inert between arcs and can be stood under safely.
