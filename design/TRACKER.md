...
- **attack L1** `[wip]` Infrequently fires up to 2 sequential zigzag lightning bolts that a long yellow tail, bounce and arc on contact with surfaces or the player. Damage and size and stun duration decrease with total travel distance
