...
- **hazard L2** `[wip]` Same sweep, plus overhead power lines now each produce a large purple vertical bolts zigzag straight downward on a regular beat. The conductors are inert between arcs and can be stood under safely.
