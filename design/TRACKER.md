...
- **attack L3** `[draft]` Boss flies around the stage just like the attack pattern of Queen B from DKC at critical health. Player takes moderate damage from contact with boss. Jetpack pushes the player in the direction of the water's travel and blocks player bullets.
- **weapon** `[wip]`
- **weapon Lv1** `[wip]`
