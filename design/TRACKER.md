...
- **weapon Lv3** `[wip]` Chain damage to 2 additional enemy, first enemy gets stunned, additional enemies do notwho does not get stunned.
- **weapon Lv6** `[draft]` 2s stun on first enemy contact; chain damage to a total of 2 additional enemies, stunned 0.5s.
