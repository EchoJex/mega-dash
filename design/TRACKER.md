...
- **hazard L2** `[wip]` Same sweep, after final panel hasthe end of the sweep of panels have discharged. The conductors are inert between arcs and can be stood under safely.
