...
## Burn
- **shared** `[wip]` Faint red hue that gets more faint until the attribute subsides.  is on fire: rapid but weak Hot DPS, no flinch or knockback, scaling down until the duration concludes.
