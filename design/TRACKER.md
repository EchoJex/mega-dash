...
- **hazard L1** `[wip]` Floor panels electrify in a very slow left-to-right sweep, one panel at a time, dischargingtelegraphed by a lamp on the panel a moment before it becomes electrified. Contact deals moderate damage and a short Stun.
