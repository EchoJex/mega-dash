...
- **hazard L2** `[wip]` First instance of player damage source nearby a time causes the ground cover to mostly recede instead of fully recede. Standing on a ground covered tile applied constrict status
