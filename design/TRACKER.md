...
- **hazard L2** `[wip]` First instance of player damage source nearby a time causes the ground cover to mostly received instead of fully receivedStanding on a ground covered tile applied constrict status
