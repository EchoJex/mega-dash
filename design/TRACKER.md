...
- **attack L2** `[wip]` Boss flies around the stage just like the attack pattern of damaged Queen B from DKC  health. Player takes moderate damage from contact with boss. Jetpack pushes the player in the direction of the water's travel and blocks player bullets.
