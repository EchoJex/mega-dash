...
- **weapon Lv3** `[wip]` Full Shield blocks the equivalent of 4 minion attacks; breaks from damage or from contact cause shield to break into 3 small ice shards that shot out from the top edge of the shield with the middle one at a 45 deg angle and side ones at 72; freezes the opponent if contacting a minion or the water boss.
