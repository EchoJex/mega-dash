...
- **weapon Lv1** `[wip]` While active enemies will fire projectiles slightly less frequently and when pursuing the player will pause very briefly at random times
