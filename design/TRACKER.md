...
- **boss-applied** `[wip]` Boss/hazard-sourced: Hot surfaces do damage/flinch/knockback to the player if touched, with hue/damage/flinch/knockback scaling down until Hot fully subsides.. In Blaze Man's arena, lingers 3s after the attribute is applied. Subsequent
