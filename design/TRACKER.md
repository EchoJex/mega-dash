...
- **attack L1** `[wip]` Infrequently fires up to 2 sequential zigzag lightning bolts that have a long yellow tail. Thesebounce and arc on contact with surfaces or the player. Damage and size and stun duration decrease with total travel distance
