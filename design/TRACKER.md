...
- **keyboard** `[wip]` A/D walks, W aims up, RSHIFT fires, double tap jump to cancel into a slide, SPACE jumps, Q/E open the in-situ wheel, ESC closes it. Esc or Enter pauses and brings up pause menu. Esc or enter key while Resume is cursored
