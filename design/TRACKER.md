...
| 1054 (main) | `[draft]` | Too many times I will defeat a boss only to be close enough to the for that it immediately warps me out. Not only should the door be visibly disabled during |
