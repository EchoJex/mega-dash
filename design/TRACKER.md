...
- **hazard L2** `[wip]` Same sweep, plus overhead power lines now produce large purple vertical bolts zigzag straight downward on a regular beat. The conductors are inert between arcs and can be stood under safely.
