...
- **weapon Lv10** `[wip]` Weapon now fires straight up instead of Auto aiming; each bullet targets a different enemy, traveling in a wide arc with high strong auto aim and rapidly acceleration bullet speed. 5 shots per second with high fire rate,  does not split; strong auto-aim. 0.125 cooldown
