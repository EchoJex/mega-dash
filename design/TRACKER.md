...
- **weapon** `[wip]` Defensive; small, grey two-nozzle jetpack that has a blue layer on top that indicates a tank fill level. Rapidly self refilling water supply when not producing weapon affects. Tank capacity and refill rate level scalable
...
- **weapon Lv10** `[wip]` All previous effects plus a large high knocked tidal wave travels in both horizontal directions when landing on the ground. Size of tidal wave is scaled with downward velocity on impact.
