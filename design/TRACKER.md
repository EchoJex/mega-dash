...
- **arena furniture** `[wip]` Two training bags swing along from above. They can be stood on by the player, and if damaged by psychic type gain a purple outline, slowly
