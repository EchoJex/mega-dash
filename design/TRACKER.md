...
- **weapon Lv1** `[wip]` Single shot, mild damage, bullet does not auto aim, 1 shot per second,  ammo clip.
- **weapon Lv3** `[wip]` Bullet has Mild auto-aim. 1, 3-bullet burst shot per second, like a rifle.
