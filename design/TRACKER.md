...
- **weapon Lv3** `[draft]` Jab chain extends to three hits; the third hit causes flinch and moderate knockback. Long-press finisher gains a short forward lunge that knocks up the target.
