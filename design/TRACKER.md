...
- **door and warp** `[wip]` The door does not open into the arena, it warps you there: contact freezes everything even player Payton, slow fade to black, builds the room behind full black, then fades back in. Nothing is ever seen half-constructed.
