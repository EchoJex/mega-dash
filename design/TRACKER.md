...
- **hazard L2** `[wip]` Same sweep, plus overhead power lines now each produce a large purple vertical lightning bolt zigzaging straight downward after the end of the. The conductors are inert between arcs and can be stood under safely.
