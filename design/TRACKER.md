...
- **hazard L2** `[wip]` Same sweep, after final panel has finished discharging, the arena brightness flickers dark normal dark, then after the last of the electrified panels have finished being . The conductors are inert between arcs and can be stood under safely.
