...
- **weapon** `[wip]` Defensive; small, two-nozzle jetpack that is blue at first but exposed a grey layer underneath as the jetpack runs dry. Rapidly self refilling if used too much,
