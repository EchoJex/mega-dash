...
- **weapon-applied** `[wip]` Enemy movement and attack speed reduced by  percent. Return to normal after 5 seconds unless additional Stun gets applied, resetting the 5 seconds duration. Stun stacks Using a multiplicative reduction of remaining speed
