...
- **weapon** `[wip]` Offensive; Large rock shaped hammer visible when active. Slow swing on tap high damage high knockback, overhead Ground-pound that creates shockwaves and stuns nearby enemies on long press (0.4s). Per-level scaling: shockwave size + stun duration.
