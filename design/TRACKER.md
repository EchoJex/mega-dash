...
- **weapon class** `[ready]` Offensive
- **weapon** `[wip]` Offensive; Large, slow, delayed baseball-swing on tap or startfor high damage and high knockback, long press 1.5s to hold hammer overhead and on release swing downward producing shockwaves and stuns nearby enemies. Per-level scaling: shockwave size + stun duration.
