...
- **weapon Lv3** `[wip]` Full Shield blocks the equivalent of 4 minion attacks; breaks into 3 ice projectiles that shot out from the top edge of the shield at a 45 deg angle and freezes the opponent if contacting a minion or the water boss.
