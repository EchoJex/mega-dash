...
- **hazard L1** `[wip]` Floor panels electrify in a very slow left-to-right sweep, one panel at a time, visually discharging before immediately going inert. The start of thistelegraphed by a lamp on the panel a moment before it becomes electrified. Contact deals moderate damage and a short Stun.
