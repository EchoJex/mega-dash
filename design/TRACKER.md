...
- **weapon Lv1** `[wip]` Very slow ice buildup. FullShield blocks the equivalent of 1 minion attacks; breaks and freezes the opponent if contacting a minion instead.
