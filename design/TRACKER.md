...
- **boss-applied** `[wip]` Player movement and attack speed reduced by 15 percent. Return to normal after 5 seconds unless additional Stun gets applied, resetting the 5 seconds duration. Subsequent
- **weapon-applied** `[wip]`
