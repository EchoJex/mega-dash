...
- **weapon Lv3** `[wip]` Full Shield blocks the equivalent of 4 minion attacks; breaks into 3 ice projectiles that shot or at a 45 def angleand freezes the opponent if contacting a minion or the water boss.
