...
| 1079 (tracker-draft/main) | `[wip]` | Post Boss requip is still popping up too early. It should pop up after the entire boss death animation has resolved. Also the wheel is closing when I did not close out off it. Also while in the boss room the player should be able to bring up the wheel |
