...
- **weapon** `[wip]` Offensive; Large rock shaped hammer. Slow swing Ground-pound that creates shockwaves and stuns nearby enemies. Per-level scaling: shockwave size + stun duration.
