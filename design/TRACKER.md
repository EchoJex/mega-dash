...
- **hazard L2** `[wip]` Same sweep, after final panel has finished discharging the room heavily. The conductors are inert between arcs and can be stood under safely.
