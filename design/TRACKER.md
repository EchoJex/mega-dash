...
- **hazard L1** `[wip]` Arena starts with 8 Ground cover tiles fully grown on the floor, covering the full width of the arena. Player damage sourcesacross the floor from both walls, covering ground over about ten seconds before retracting. Standing on a covered tile deals light repeating damage.
