...
- **weapon Lv1** `[wip]` Standard home run swingAirborne swings cause the player to swing downward and rapidly travel downward where a shockwave will be generated on contact with the ground
