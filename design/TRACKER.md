...
- **weapon-applied** `[wip]` player is immune to own Hot; Spot is 'red hot'. add a low transparency red hue that becomes more transparent as the effect diminishes; mild damage/flinch/knockback on touch and applies burn, all of which scale down until Hot subsides. Hot affect shall last for 5s unless reapplied
