...
- **weapon** `[wip]` Defensive; reduces aggro and become immune to stays affects. Throws a dark energy boomerang that steals a small amount of enemy health. Per-level scaling: faster return + more health steal.
