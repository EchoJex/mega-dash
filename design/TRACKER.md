...
- **hazard L3** `[wip]` The sweep runs in both directions at once, meeting in the middle. Vertical Bolts now chain through nearby minions and into the player if the player is close to them, destroying the minions and damaging the player and applying stun
