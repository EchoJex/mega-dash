...
- **arena** `[wip]` All furniture, hazards, and boss layer attacks shall be synched to a 0.5s beat. Two industrial speakers with pulsing membrane pulse every .5s ; several platforms phase in and out slowly in genuinely random locations
