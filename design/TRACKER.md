...
- **hazard L1** `[wip]` Arena starts with Ground cover grows on the floor. across the floor from both walls, covering ground over about ten seconds before retracting. Standing on a covered tile deals light repeating damage.
