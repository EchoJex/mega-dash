...
- **hazard L2** `[wip]` First instance of player damage source nearby a time causes the ground cover toStanding on a ground covered tile applied constrict status
