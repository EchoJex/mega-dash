...
## Burn
- **shared** `[wip]` Character attribute: Faint red hue that gets more faint until the attribute subsides. Smoke trails behind the characterThe player or enemy is on fire: rapid but weak burn DPS, no flinch or knockback, scaling down until the duration concludes.
