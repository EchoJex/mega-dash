...
- **weapon Lv10** `[wip]` All previous effects plus a large tidal wave travels in both horizontal directions when landing on the ground. Activated by tapping jump after a water hover hasSize of tidal wave is scaled with downward velocity on impact.
