...
- **silhouette** `[wip]` Rename silhouette in this tracker for all bosses to Sprite sheet. No text field, only small check boxes for furniture, Arena background, Boss, Boss ATK.
