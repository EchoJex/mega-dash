...
## Game pacing
Limit of 2 offensive weapons, 2 defensive weapons, plus the mega buster (which will now be called a sidearm). Load out change is part of the now weapon acquire sequence upon defeating boss. If boss was defensive special weapon unlock then allow requip of defensive slots with any unlocked defensive and if boss was offensive special weapon unlock then allow requip of offensive special weapons
## Play feel
