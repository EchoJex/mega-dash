...
- **weapon Lv1** `[wip]` Very slow ice buildup. Full Shield blocks the equivalent of 3 minion attacks; breaks and freezes the opponent if contacting a minion instead.
