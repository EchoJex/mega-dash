...
- **attack L2** `[wip]` 2 sets of bolts with a longer bounce life, for as a primarya second volley on a shallower angle before the first has finished, so two zigzag paths overlap.
