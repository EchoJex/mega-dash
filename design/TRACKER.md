...
## Hot
- **shared** `[wip]` Faint red hue that gets more faint until the attribute subsides. New sources applying hot to a surface override existing hot attribute. Causes burn on contact
