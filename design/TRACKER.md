...
- **weapon** `[wip]` Defensive; small, grey two-nozzle jetpack that has aunderneath as the jetpack runs dry. Rapidly self refilling water supply when not producing weapon affects.
