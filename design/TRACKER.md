...
- **attack L1** `[wip]` Boss flies around the stage just like the attack pattern of Queen B from DKC at full. Player takes moderate damage from contact with boss. Jetpack pushes the player in the direction of the water's travel and blocks player bullets.
