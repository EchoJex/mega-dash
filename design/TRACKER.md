...
- **weapon** `[wip]` Defensive; small, grey two-nozzle jetpack that is blue at first but exposes a grey layer underneath as the jetpack runs dry. Rapidly self refilling water supply when not producing weapon affects.
