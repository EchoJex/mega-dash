...
- **weapon** `[wip]` Offensive; Close-range powerful punch with knockback and damage reduction during attack animations. Tap attack for a quick low-damage lungeing  combo-starter jab; long-press attack 0.4s for a combo finisher.
