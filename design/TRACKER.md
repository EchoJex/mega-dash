...
- **weapon Lv1** `[draft]` Burst of mild damage large knockback water when jumping or double jumping and upon landing on the ground
- **weapon Lv3** `[wip]` Add the ability to hover briefly at the apex of any jump which while shooting two water jets directly downward
