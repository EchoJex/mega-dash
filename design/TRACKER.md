...
- **weapon** `[wip]` Defensive; Forms a large shield of ice in front of the player that slowly buildwhile the attack button is pressed. Short cooldown if released; long cooldown if destroyed by damage.
