...
- **attack L2** `[wip]` 2 sets of bolts with a longer bounce life, fired as a primary volley and a secondary volley which on a shallower angle before the first has finished, so two zigzag paths overlap.
