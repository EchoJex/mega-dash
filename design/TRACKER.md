...
- **hazard L2** `[wip]` First instance of player damage source nearby a time causes the ground cover to mostly recede instead of fully recede. 2nd damage source within 1 service caused it to fully received for the full duration.  Standing on a ground covered tile applied constrict status
