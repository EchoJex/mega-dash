...
- **weapon** `[wip]` Defensive; small, grey two-nozzle jetpack that has a blue layer on top that indicates a tank fill levelunderneath as the jetpack runs dry. Rapidly self refilling water supply when not producing weapon affects.
