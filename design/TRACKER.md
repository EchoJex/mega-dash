...
- **weapon Lv3** `[wip]` Full Shield blocks the equivalent of 4 minion attacks; breaks into 3 ice projectiles that shot out at a 45 deg angle from the top edge of theand freezes the opponent if contacting a minion or the water boss.
