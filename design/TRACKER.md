...
- **weapon** `[wip]` Offensive; Close-range powerful punch with knockback and damage reduction during attack animations. Tap attack for a quick low-damage mini-dash combo-starter jab; long-press attack 0.4s for a combo finisher.
- **weapon Lv1** `[wip]` 2 jabs, or 1 jab and one combo finisher.
- **weapon Lv3** `[wip]` Jab chain extends to three hits; the third hit staggers. Long-press finisher gains a short forward lunge.
