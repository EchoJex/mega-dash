...
- **hazard L2** `[wip]` Same sweep, after final panel has finished discharging, the arena brightness. The conductors are inert between arcs and can be stood under safely.
