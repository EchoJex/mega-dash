...
- **arena furniture** `[wip]` Two training bags swing along from above. One bag at layer 1; two from layer 2, started at opposite ends of different rails so where they cross drifts down the room.
