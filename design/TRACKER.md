...
- **weapon class** `[ready]` Offensive
- **weapon** `[wip]` Offensive; Large, slow, delayed baseball-swing on tap or start of long press for high damage and high knockback, long press 1.5s to hold hammer overhead (visiblyand on release swing downward producing shockwaves and stuns nearby enemies. Per-level scaling: shockwave size + stun duration.
