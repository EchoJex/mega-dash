...
- **weapon** `[wip]` Defensive; small, grey two-nozzle jetpack that has a blue layer on top thatunderneath as the jetpack runs dry. Rapidly self refilling water supply when not producing weapon affects.
