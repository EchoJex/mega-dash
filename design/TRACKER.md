...
- **weapon Lv1** `[wip]` Very slow ice buildup. Full Shield blocks the equivalent of 3 minion projectile; breaks and freezes the opponent if contacting a minion instead.
- **weapon Lv3** `[wip]` Shield blocks the equivalent of 4 minion attacks; breaks and freezes the opponent if contacting a minion instead.
