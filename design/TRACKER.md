...
- **weapon Lv10** `[wip]` Weapon now fires straight up instead of Auto aiming; bullets travel in a wide arc towardwith high precision5 shots per second with high fire rate,  does not split; strong auto-aim. 0.125 cooldown
