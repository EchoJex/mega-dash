...
- **attack L3** `[wip]` Bolts no longer lose size on bounce, only reduce in damage delt. Occasionally the boss discharges into the floor, briefly energising every panel the last bolt touched.
- **weapon class** `[ready]` Offensive
