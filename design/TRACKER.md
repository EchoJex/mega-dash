...
- **weapon** `[wip]` Offensive; Large rock shaped hammer. Slow swing on tap, overhead Ground-pound that creates shockwaves and stuns nearby enemies on . Per-level scaling: shockwave size + stun duration.
