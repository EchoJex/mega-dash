...
- **boss layers** `[wip]` Per boss, 1 to 3, earned by lifetime clears of that boss. A layer-2 boss uses layer-2 hazards AND layer-2 attacks. Game over once lifetime kill of all bosses at level 1-3 is >0
