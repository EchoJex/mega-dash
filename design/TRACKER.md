...
- **attack L1** `[wip]` Infrequently fires up to 1 zigzag lightning bolt  that has a long yellow tail. These lightning bolts bounce on wide arcs on surfaces, on contact with the player deal mild damage and apply mild stun. Damage and size and stun duration decrease with total travel distance
