...
- **attack L3** `[wip]` Moves back and forth across the stage, occasionally stopping, waiting a moment, then fire either a set of 2 3-bullet spread directly forward toward the player with mild auto-aim or aim directly at the player, tracking the players continuously while shooting a string of 5-10 bullets that do not auto aim, either way, dealing small damage.
